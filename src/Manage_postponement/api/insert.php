...
<head>
    ...
    <title> การเพิ่มข้อมูล การเลื่อนนัด </title>
</head>
...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล การเลื่อนนัด</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="Insertpostponement.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="70%" border="1" style="border: #d6913a double 5px;">
                        ...
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> วันที่เก่า :</b></td>
                            <td width="80%">
                                <input type="date" name="old_date" id="old_date" style="width: 100%" required/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <input type="hidden" name="status" id="status" value="อนุมัติ" />
                    </table>
