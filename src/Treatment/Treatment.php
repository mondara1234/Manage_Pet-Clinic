...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="Inserthistory.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="90%" border="1" style="border: #d6913a double 5px;">
                        ...
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> หัวข้อการรักษา :</b></td>
                            <td width="80%"><input type="text" name="title" style="width: 100%" required/></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> วันที่รักษา :</b></td>
                            <td width="80%">
                                <input type="date" name="date" id="date" style="width: 100%" required/>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> เวลาที่รักษา :</b></td>
                            <td width="80%">
