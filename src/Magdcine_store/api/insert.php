...
<head>
    ...
    <title> การเพิ่มข้อมูล ประวัติการรักษา </title>
</head>
...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล ยา</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="InsertDrug.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="90%" border="1" style="border: #d6913a double 5px;">
                        <tr>
                            ...
                            <td width="80%"><input type="text" name="name" style="width: 100%" required/></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right"><b style="margin-right: 2%;"> รูปยา :</b></td>
                            <td width="80%">
                                <input type="file" name="pDrugIMG" id="pDrugIMG" required/>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> สรรพคุณ :</b></td>
                            <td width="80%">
                                <textarea rows="6" name="properties" style="width: 100%; resize: none;" required></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" align="right"><b style="margin-right: 2%;"> จำนวนคงเหลือ :</b></td>
                            <td width="80%"><input type="number" name="total" style="width: 100%" required/></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right"><b style="margin-right: 2%;"> ราคา/หน่วย :</b></td>
                            <td width="80%"><input type="number" name="price" style="width: 100%" required/></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right"><b style="margin-right: 2%;"> ชื่อเจ้าของยา :</b></td>
                            <td width="80%">
                                <input type="text" name="name_Owner" id="name_Owner" style="width: 100%" required/>
                            </td>
                        </tr>
                    </table>
