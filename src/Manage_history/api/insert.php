...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล ประวัติการรักษา</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="../../Treatment/InsertTreatment.php" method="post" enctype="multipart/form-data" target="iframe_target">
