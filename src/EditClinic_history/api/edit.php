            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">การแก้ไขข้อมูล ประวัติการรักษา</h4>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                    ...
                    <form name="edit" action="updated.php?UserName=<?php echo($_GET["UserName"]); ?>" method="post" enctype="multipart/form-data" target="iframe_target">
                        ...
                        <table width="90%" border="1" style="border: #d6913a double 5px;">
                            ...
                            <tr>
                                ...
                                <td width="80%">
                                    <textarea rows="5" name="symptom" style="width: 100%; resize: none" required><?php echo ($result["symptom"]) ?></textarea>
                                </td>
                            </tr>
                            <tr>
